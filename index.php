...
<body>
    <header>
        <nav>
            ...
            <ul id="menu_box">
                ...
                <li><button onclick="location.href='/Login/login.php' ">Register</button></li>
            </ul>
        ...
        <div class="content">
            <div class="cont_box">
                ...
                <input type="submit" value="Book your trip">
                </form>
            </div>
            <div class="trip_box">
                <div class="travel_box">
                    ...
                    <div class="cards">
                        ...
                        <div class="card">
                            ...
                            <div class="btn_city">
                                <a href="/EuropeTravel/europe.php">Read Now</a>
    ...
    <footer>
        ...
        <p>You can find everything from flights, hotels, and restaurants to car rentals and local experiences online.</p>
        <div class="input">
